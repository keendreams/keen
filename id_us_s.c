...
scr_rowcol(15,9)      scr_aputs("         This is the REGISTERED VERSION of KEEN DREAMS.",0x70);
scr_rowcol(15,64)      scr_aputs(" ",0x7E);
scr_rowcol(15,65)      scr_aputs("           ",0x7A);
...
scr_rowcol(16,8)      scr_aputs("      It is licensed soley to the original registered user.",0x70);
scr_rowcol(16,67)      scr_aputs("       ",0x7A);
...
scr_rowcol(17,8)      scr_aputs("   This software is NOT Shareware.  Please do not distribute.",0x70);
